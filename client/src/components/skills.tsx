                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {category.technologies.map((tech, techIndex) => (
                    ...
                    >
                      ...
                      <tech.Icon
                        className={`text-3xl ${tech.color} group-hover:scale-110 group-hover:drop-shadow-lg transition-all duration-300 mx-auto relative z-10 mb-1`}
                      />
                      <p className="text-xs text-center text-muted-foreground group-hover:text-foreground group-hover:font-medium transition-all duration-300 relative z-10 leading-tight">
                        {tech.name}
                      </p>
